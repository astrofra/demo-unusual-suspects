...
OBJ = main.o init.o 3d_routines.o \
		Assets/cosine_table.o Assets/object_cube.o Assets/object_amiga.o Assets/object_face_00.o Assets/object_spiroid.o Assets/misc_palettes.o Assets/faces_palettes.o

thanks-andy: $(OBJ) includes.gst
	sc LINK CODE=F DATA=F OBJ $(OBJ) TO thanks-andy

includes.gst: includes.prl
main.o: main.c common.h protos.h 3d_routines.h Assets/cosine_table.h Assets/object_amiga.h Assets/misc_palettes.h Assets/faces_palettes.h includes.gst
